    ...
    >
      <div class="flex items-center justify-between mb-6">
        ...
        <h1 class="text-3xl font-extrabold text-gray-900 text-center">
          Récapitulatif des opérations récurrentes – Mois de
          {{
          ...
          <tbody>
            <tr>
              <td class="px-4 py-2 text-left text-lg font-bold text-green-700">
                {{
                  totalSorti.toLocaleString('fr-FR', {
                    style: 'currency',
                    currency: 'EUR',
                  })
                }}
              ...
              <td class="px-4 py-2 text-left text-lg font-bold text-green-700">
                {{
                  totalRentre.toLocaleString('fr-FR', {
                    style: 'currency',
                    currency: 'EUR',
                  })
                }}
              ...
              <td class="px-4 py-2 text-right text-lg font-bold text-blue-700">
                {{
                  totalAPrevoir.toLocaleString('fr-FR', {
                    style: 'currency',
                    currency: 'EUR',
                  })
                }}
              ...
              <td class="px-4 py-2 text-right text-lg font-bold text-blue-700">
                {{
                  totalARentrer.toLocaleString('fr-FR', {
                    style: 'currency',
                    currency: 'EUR',
                  })
                }}
